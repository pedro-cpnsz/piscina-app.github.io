...
<table border=1>
    ...
    <tr>
        ...
        <td><?=$value["email"];?></td>
        <td>
            <a href="index.php?pagina=formEditarUsuario.php&isAuthenticate=1&id=<?=$id;?>">[EDITAR]</a>
            <a href="index.php?pagina=excluirUsuario.php&isAuthenticate=1&id=<?=$id;?>">[EXCLUIR]</a>
        </td>
    </tr>
    <?php
        }
